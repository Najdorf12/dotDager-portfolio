    ...
    <>
      ...
      >
        ...
        <article className="relative text-balance flex flex-col h-full justify-center gap-6 items-center md:items-start z-50 lg:w-[55%] xl:w-[50%] 2xl:gap-12">
          ...
          <p className="font-title  flex flex-col justify-center items-center  text-center font-normal  text-base text-stone-500 max-w-[800px]  md:items-start md:justify-start md:text-start px-2 md:px-0 xl:pr-6 2xl:pr-3  2xl:text-xl   ">
